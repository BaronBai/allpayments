...
class PayNotifyByJDTest extends TestCase
{
    ...
    public function testPayExceptionBySuccessToFalse(){
        $resource = mockResponse($this->dirName.'/temp/jd.response/success_to_false.json');
    ...
    public function testPayExceptionBySignFail(){
        ...
        $resource = mockResponse($this->dirName.'/temp/jd.response/sign_fail.json');
        $content = $resource->getBody()->getContents();
        $this->client->notify($content, function($content){
            return true;
        });
    ...
    public function testSuccess(){
        ...
        $resource = mockResponse($this->dirName.'/temp/jd.response/sign_success.json');
        $content = $resource->getBody()->getContents();
