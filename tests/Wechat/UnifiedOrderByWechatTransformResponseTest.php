...
class UnifiedOrderByWechatTransformResponseTest extends TestCase
{
    ...
    */
    ...
    public function testPayExceptionByReturnCodeFail(){
        ...
        $response = mockResponse(TEMP_DIR."/wechat_pay_fail_response.xml");
    ...
    public function testPayExceptionByResultCodeFail(){
        ...
        $response = mockResponse(TEMP_DIR."/wechat_pay_fail_response2.xml");
        $this->client->transformResponse($response);
    ...
    public function testPayExceptionByVerifySignFail(){
        ...
        $response = mockResponse(TEMP_DIR."/wechat_pay_response_sign_fail.xml");
        $this->client->transformResponse($response);
    ...
    public function testSuccess(){
        $response =  mockResponse(TEMP_DIR."/wechat_pay_response_sign_success.xml");
